...
export function activate(context: vscode.ExtensionContext) {
  ...
  console.log(
    'Congratulations, your extension "verilog-autoline" is now active!'
  );
  ...
  let disposable = vscode.commands.registerCommand(
    ...
    () => {
      ...
      var text_Range = new vscode.Range(
        ln_st,
        0,
        sel.end.line,
        last_line.range.end.character
      );
      editor.edit(builder => {
